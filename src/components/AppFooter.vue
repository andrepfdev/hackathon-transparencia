...
const quickLinks = [
  { label: 'DADOS ABERTOS', sublabel: 'MA.GOV.BR', icon: 'pi pi-database', href: '#' },
  { label: 'Diário Oficial', sublabel: '', icon: 'pi pi-book', href: '#' },
  { label: 'FALA', sublabel: 'MA.GOV.BR', icon: 'pi pi-comments', href: '#' },
]
</script>
